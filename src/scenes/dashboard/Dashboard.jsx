        ...
        <Box m="20px">
            ...
            <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="140px" gap="20px" mt="40px">
                ...
                <Box gridColumn="span 8" gridRow="span 2" bgcolor={colors.primary[400]}>
                    <Box display="flex" justifyContent="space-between" alignItems="center" mt="25px" p="0 30px">
                        <Box>
                            <Typography color={colors.grey[100]} variant="h5" fontWeight="600">
                                Revenue Generated
                            </Typography>
                            <Typography color={colors.greenAccent[500]} variant="h3" fontWeight="bold">
                                $59,342.32
                            </Typography>
                        </Box>
                        <Box>
                ...
                <Box gridColumn="span 4" gridRow="span 2" bgcolor={colors.primary[400]} p="30px">
                    ...
                    <Box display="flex" flexDirection="column" alignItems="center" mt="25px">
                        ...
                        <Typography color={colors.greenAccent[500]} variant="h5" sx={{ mt: "15px" }}>
